...
namespace SDK
{
	...
	{
		extern int GObjects;
		extern int AppendString;
		extern int GNames;
		extern int GWorld;
		extern int ProcessEvent;
		extern int ProcessEventIdx;
	}
...
public:
	inline void InitGObjects()
	{
		...
		//std::cout << "Fuck me harder " << std::hex << static_cast<void*>(GObjectsAddress) << std::dec << std::endl;
	}
...
public:
	static void InitInternal()
	{
		...
		//std::cout << "Fuck me " << std::hex << static_cast<void*>(GNames) << std::dec << std::endl;
	}
...
enum class EIncludeSuperFlag : int32
{
	ExcludeSuper = 0x0,
	IncludeSuper = 0x1,
};
