...
namespace DX12
{
	...
	extern Present12 oPresent;
	extern CreateCommandQueue oCreateCommandQueue;
	extern CreateSwapChain oCreateSwapChain;
	...
	namespace DirectX12Interface {
		...
		extern ID3D12DescriptorHeap*		BlurDescriptor;
		extern D3D12_CPU_DESCRIPTOR_HANDLE	BlurCpu;
		extern D3D12_GPU_DESCRIPTOR_HANDLE	BlurGpu;
		extern UINT							BlurHeapIncrement;
