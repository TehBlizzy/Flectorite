...
namespace TFD
{
	// Forward declarations for the new cosmetic functions
	typedef void(__fastcall* tReceiveCustomizingItem)(UM1PrivateOnlineServiceCustomize* This, FM1TemplateId InTargetTid, FM1TemplateId InItemTid, bool bEquip, EM1CustomizeReason InReason);
	...
	tReceiveCustomizingItem native_ReceiveCustomizingItem = nullptr;
	...
	class UM1UIActorWidget* UM1ActorWidgetComponent::GetActorWidget() const
	{
		static class UFunction* Func = nullptr;

		if (Func == nullptr)
			Func = Class->GetFunction("M1ActorWidgetComponent", "GetActorWidget");

		struct
		{
			class UM1UIActorWidget* ReturnValue;
		} Parms{};
	...
	bool AActor::K2_SetActorLocationAndRotation(const struct FVector& NewLocation, const struct FRotator& NewRotation, bool bSweep, struct FHitResult* SweepHitResult, bool bTeleport)
	{
		...
		Actor_K2_SetActorLocationAndRotation Parms{};
	...
	bool UM1SkillAbility::CanActivateAbility(const class AActor* InOwner) const
	{
		static class UFunction* Func = nullptr;

		if (Func == nullptr)
			Func = Class->GetFunction("M1SkillAbility", "CanActivateAbility");

		M1SkillAbility_CanActivateAbility Parms{};
		Parms.InOwner = const_cast<AActor*>(InOwner);
	...
	void UM1PlayerVehicleHandlerComponent::ServerSpawnEquippedVehicle(bool bImmediately, bool bForceSpawn)
	{
		static class UFunction* Func = nullptr;
	...
	void UM1PlayerVehicleHandlerComponent::ServerRequestDismountVehicle(const struct FGameplayTag& InQueryTag)
	{
		static class UFunction* Func = nullptr;

		if (Func == nullptr)
			Func = Class->GetFunction("M1PlayerVehicleHandlerComponent", "ServerRequestDismountVehicle");

		M1PlayerVehicleHandlerComponent_ServerRequestDismountVehicle Parms{};

		Parms.InQueryTag = std::move(InQueryTag);
	...
	bool UM1GameplayUtil::LineTraceFromViewport(const class AActor* Owner, const struct FVector& BaseLoc, const float Range, const ECollisionChannel TraceChannel, bool bCheckValidTarget, const bool bTraceComplex, TArray<struct FHitResult>* OutHits)
	{
		static class UFunction* Func = nullptr;

		if (Func == nullptr)
			Func = StaticClass()->GetFunction("M1GameplayUtil", "LineTraceFromViewport");

		struct
		{
			const class AActor* Owner;
			struct FVector BaseLoc;
			float Range;
			ECollisionChannel TraceChannel;
			bool bCheckValidTarget;
			bool bTraceComplex;
		...
		Parms.Owner = Owner;
		Parms.BaseLoc = BaseLoc;
		Parms.Range = Range;
		Parms.TraceChannel = TraceChannel;
		Parms.bCheckValidTarget = bCheckValidTarget;
	...
	float UKismetMathLibrary::Distance(const struct FVector& A, const struct FVector& B)
	{
		static class UFunction* Func = nullptr;

		if (Func == nullptr)
			Func = StaticClass()->GetFunction("KismetMathLibrary", "Distance");
