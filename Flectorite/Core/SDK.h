...
namespace TFD
{
	...
	public:
		...
		class USceneComponent* RootComponent;                                     // 0x0150(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
		uint8                                         Pad_AActor_Class[0xF0]; // 0x158 F8
	...
	struct FEngineShowFlags
	{
		...
		int VisualizeNanite;
		int VisualizeLumen;
		int VisualizeSubstrate;
		int VisualizeGroom;
		int VisualizeVirtualShadowMap;
		int PointLights;
		int SpotLights;
		int RectLights;
		int DepthOfField;
		int MotionBlur;
		int CameraInterpolation;
		int ToneCurve;
		int SeparateTranslucency;
		int ScreenPercentage;
		int ReflectionEnvironment;
		int Specular;
		int ScreenSpaceReflections;
		int LumenReflections;
		int ContactShadows;
		int RayTracedDistanceFieldShadows;
		int CapsuleShadows;
		int VolumetricLightmap;
		int IndirectLightingCache;
		int TexturedLightProfiles;
		int LightFunctions;
		int InstancedStaticMeshes;
		int InstancedFoliage;
		int InstancedGrass;
		int DynamicShadows;
		int Particles;
		int SkeletalMeshes;
		...
		int HMDDistortion;
		int StereoRendering;
		int DistanceCulledPrimitives;
		int SkyLighting;
		int Paper2DSprites;
		int ScreenSpaceAO;
		int DistanceFieldAO;
		int LumenGlobalIllumination;
		int VolumetricFog;
		int WidgetComponents;
		int MediaPlanes;
		int PathTracing;
		int VisualizeCalibrationColor;
		int VisualizeCalibrationGrayscale;
		int VisualizeCalibrationCustom;
		int LumenScreenTraces;
		int LumenDetailTraces;
		int LumenGlobalTraces;
		int LumenFarFieldTraces;
		int LumenSecondaryBounces;
		int LumenShortRangeAmbientOcclusion;
		int NaniteMeshes;
		int NaniteStreamingGeometry;
		int ShaderPrint;
	};
	...
	public:
		...
		uint8 Pad_ViewMode[0x68];			// 0x48
		uint32 ViewModeIndex;				// 0xB0
	};
	...
	{
	public:
		uint8 Pad_APlayerCameraManager_Class[0x0018]; // 0x0248
		float DefaultFOV; // 0x0260(0x0004)
		uint8 Pad_APlayerCameraManager_Class2[0x36CC]; // 0x0264
	public:
	...
	class UM1GameSetting : public UObject
	{
	public:
		char Pad_FireLocationAllowDistance[0xE8];	// 0x0028
		float FireLocationAllowDistance;			// 0x0110
		float FireDirectionAllowRatio;				// 0x0114
		float HitValidationPrecision;				// 0x0118
		char Pad_TraceStartLocDiffTolerance[0x14];	// 0x011C
		float TraceStartLocDiffTolerance;			// 0x0130
		char Pad_WeaponRangeTolerance[0xC];			// 0x0134
		float WeaponRangeTolerance;					// 0x0140

		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1GameSetting">();
		}
		static class UM1GameSetting* GetDefaultObj()
		{
			return GetDefaultObjImpl<UM1GameSetting>();
		}
	};

	//static_assert(offsetof(UM1GameSetting, WeaponRangeTolerance) == 0x140, "Bad alignment");
...
#pragma pack(pop)
	...
	{
	public:
		uint8 Pad_UMovementComponent_Class[0x90];
	};
	...
	{
	public:
		uint8 Pad_UPawnMovementComponent_Class[0x20];
	};

	// 0x0AF8 (0x0C30 - 0x0138)
	...
	public:
		...
		uint8 Pad_160[0x1C];                                     // 0x0160(0x001C)
		float WalkableFloorAngle;                                // 0x017C(0x0004)
		float WalkableFloorZ;                                    // 0x0180(0x0004)
		uint8 MovementMode;                                      // 0x0184(0x0001)
		uint8 CustomMovementMode;                                // 0x0185(0x0001)
		uint8 NetworkSmoothingMode;                              // 0x0186(0x0001)
		uint8 Pad_187[0x1];                                      // 0x0187(0x0001)
		float GroundFriction;                                    // 0x0188(0x0004)
		uint8 Pad_18C[0x20];                                     // 0x018C(0x0020)
		...
		uint8 Pad_1C4[0xA6C];                                    // 0x01C4 - rest of class
	...
	// 0x0000 (0x0028 - 0x0028)
	class UM1GameplayUtil final : public UBlueprintFunctionLibrary
	{
	public:
		static bool LineTraceFromViewport(const class AActor* Owner, const struct FVector& BaseLoc, const float Range, const ECollisionChannel TraceChannel, bool bCheckValidTarget, const bool bTraceComplex, TArray<struct FHitResult>* OutHits);

	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1GameplayUtil">();
		}
		static class UM1GameplayUtil* GetDefaultObj()
		{
			return GetDefaultObjImpl<UM1GameplayUtil>();
		}
	};
	// 0x0000 (0x0028 - 0x0028)
	...
	struct FM1CustomizeSkinPaintInfo final
	{
	public:
		TArray<struct FM1PaintData>                   Paints;                                            // 0x0000(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
		EM1CustomizeSkinNormalPaintType               PaintType;                                         // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	{
	public:
		struct FM1TemplateId                          TargetTid;                                         // 0x0000(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		struct FM1TemplateId                          SkinTid;                                           // 0x0004(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		TArray<struct FM1CustomizeSkinPaintInfo>      NormalPaints;                                      // 0x0008(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
		TArray<struct FM1PaintData>                   HairPaints;                                        // 0x0018(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
		int32                                         LoadoutSlotIndex;                                  // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		int32                                         EvolutionLevelIndex;                               // 0x002C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	};
	...
	// Class M1.M1PlayerAttribute
	// 0x0E20 (0x0F60 - 0x0140)
	class UM1PlayerAttribute final : public UM1CharacterAttribute
	{
	public:
		uint8 Pad_000[0x9E0]; // Padding before floats to reach 0x0B20

		float ContextualProbeInterval;           // 0x0B20(0x0004)
		float ContextualProbe_UpperHeight;       // 0x0B24(0x0004)
		float ContextualProbe_UpperLength;       // 0x0B28(0x0004)
		float ContextualProbe_LootRadius;        // 0x0B2C(0x0004)
		float ContextualProbe_ProjectileRadius;  // 0x0B30(0x0004)

		uint8 Pad_After[0x42C]; // Padding after last float until end of class

	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1PlayerAttribute">();
		}
		static class UM1PlayerAttribute* GetDefaultObj()
		{
			return GetDefaultObjImpl<UM1PlayerAttribute>();
		}
	};
	...
	{
	public:
		float                                         MaxAcceleration;                                   // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		...
		float                                         BackwardSpeedFactor;                               // 0x000C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         LateralSpeedFactor;                                // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         MaxTurnSpeed;                                      // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		...
		float                                         BrakingFriction;                                   // 0x001C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         ForwardFrictionFactor;                             // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         LateralFrictionFactor;                             // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         BrakingDeceleration;                               // 0x0028(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         MaxStepHeight;                                     // 0x002C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         WalkableFloorAngle;                                // 0x0030(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         SmoothZSpeed;                                      // 0x0034(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		uint8                                         SmoothZSpeedCurve[0x88];
	...
	{
	public:
		struct FM1VehicleMovementData			BaseMovementData;		// 0x0338(0x00C0)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
		uint8 Pad_VehCustomizeComponent[0x310];							// 0x03F8
		class UM1VehicleCustomizeComponent* CustomizeComponent;		// 0x0708(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
		uint8 Pad_CurrentMovementData[0x10];							// 0x0710
		struct FM1VehicleMovementData			CurrentMovementData;	// 0x0720(0x00C8)(Transient, Protected, NativeAccessSpecifierProtected)
	...
	static_assert(offsetof(AM1Vehicle, CurrentMovementData) == 0x720, "Bad alignment");
	...
	public:
		...
		void ServerSpawnEquippedVehicle(bool bImmediately, bool bForceSpawn);
	...
	{
	public:
		uint8 Pad_TeleportHandler[0x368]; // 0xC70
		class UM1TeleportHandlerComponent* TeleportHandler; // 0x0FD8(0x0008)
		uint8 Pad_WeaponSlotControl[0x10]; // 0xFE0
		class UM1WeaponSlotControlComponent* WeaponSlotControl; // 0x0FF0(0x0008) Need this
		uint8 Pad_RoundsComponent[0x30]; // 0x0FF8
		class UM1PlayerRoundsComponent* RoundsComponent; // 0x1028
		uint8 Pad_CustomizeComponent[0x10];    // 0x1030
		class UM1PlayerCustomizeComponent* CustomizeComponent; // 0x1040(0x0008)
		uint8 Pad_WireCaster[0x20];    // 0x1048
		class UM1PlayerVehicleHandlerComponent* VehicleHandlerComponent; // 0x1068(0x0008)
		class AM1WireCaster* WireCaster; // 0x1070
		class FString PlayerName; // 0x1078
	...
	{
	public:
		uint8                                         Pad_475[0x8];                                      // 0x0470(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
		struct FColor                                 ShapeColor;                                        // 0x0478(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		uint8                                         bDrawOnlyIfSelected : 1;                           // 0x047C(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
		uint8                                         bShouldCollideWhenPlacing : 1;                     // 0x047C(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
		uint8                                         bDynamicObstacle : 1;                              // 0x047C(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
		uint8                                         Pad_47D[0x3];                                      // 0x047D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
		TSubclassOf<class UNavAreaBase>               AreaClassOverride;                                 // 0x0480(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
		uint8                                         bUseSystemDefaultObstacleAreaClass : 1;            // 0x0488(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
...
#pragma pack(push, 0x1)
	...
	{
	public:
		float                                         SphereRadius;                                      // 0x0490(0x0004)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
#pragma pack(pop)
	...
	// Class M1.M1MissionTaskMoveWayPoint
	// 0x0018 (0x0260 - 0x0248)
	class AM1MissionTaskMoveWayPoint : public AActor
	{
	public:
		class UM1ActorWidgetComponent* WidgetComponent;                                   // 0x0248(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		class USphereComponent* CollisionComponent;                                // 0x0250(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1MissionTaskMoveWayPoint">();
		}
		static class AM1MissionTaskMoveWayPoint* GetDefaultObj()
		{
			return GetDefaultObjImpl<AM1MissionTaskMoveWayPoint>();
		}
	};
	...
	{
	public:
		class UTexture2D* Sprite;                                            // 0x0470(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		uint8                                         bIsScreenSizeScaled : 1;                           // 0x0478(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
		uint8                                         Pad_479[0x3];                                      // 0x0479(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
		float                                         ScreenSize;                                        // 0x047C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         U;                                                 // 0x0480(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         UL;                                                // 0x0484(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         V;                                                 // 0x0488(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         VL;                                                // 0x048C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		float                                         OpacityMaskRefVal;                                 // 0x0490(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	public:
		...
		uint8 Pad_00B0[0x0008];
		int32                                         TaskIndex;                                         // 0x00A8(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8 Pad_00A0[0x021E];                               // 0x00A0(0x021E)(Fixing Size After Last Property)
...
#pragma pack(push, 0x1)
	...
	public:
		...
		TArray<class UM1ActorWidgetComponent*>        ActorWidgetsOfWayPointsAndTask;                    // 0x0678(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
		uint8                                         Pad_AM1MissionTaskActor[0x1E0];				     // 0x0688
	public:
		static class UClass* StaticClass()
		{
...
#pragma pack(pop)
	...
	public:
		...
		uint8                                         Pad_AM1MissionActor_Class[0x298];                      // 0x03D8
	...
	public:
		...
		void* MaterialComponent;              // 0x0450(0x0008)
	...
	{
	public:
		uint8 Pad_30[0x30];                                      // 0x0030(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	{
	public:
		uint8                                         Pad_250[0x294];                                    // 0x0250(0x0294)(Padding to WidgetSize)
		struct FVector2D                              WidgetSize;                                        // 0x04E4(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		uint8                                         Pad_4EC[0x4];                                      // 0x04EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
		class USizeBox* WidgetSizeBox;                                     // 0x04F0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		uint8                                         Pad_4F8[0x230];                                    // 0x04F8(0x0230)(Remaining padding to maintain size)
	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1UIWidget">();
		}
		static class UM1UIWidget* GetDefaultObj()
		{
			return GetDefaultObjImpl<UM1UIWidget>();
		}
	};
	...
	// Class M1.M1ActorWidgetComponent
	...
	public:
		...
		TSoftClassPtr<class UClass>                   ActorWidgetClass;                                  // 0x0208(0x0030)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
		TWeakObjectPtr<class UM1UIActorWidget>        ActorWidget;                                       // 0x0238(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
		uint8                                         Pad_240[0x14];                                     // 0x0240(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
		bool                                          bLockInViewport;                                   // 0x0254(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
		uint8                                         Pad_255[0x3];                                      // 0x0255(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
		float                                         InterpSpeed;                                       // 0x0258(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
		uint8                                         Pad_25C[0x4];                                      // 0x025C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
		float                                         VisibilityAndOpacityUpdateInterval;                // 0x0260(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
		uint8                                         Pad_264[0x2];                                      // 0x0264(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
		bool                                          bTreatLikeAlwaysFocused;                           // 0x0266(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8                                         Pad_267[0x1AD];                                    // 0x0267(0x01AD)(Fixing Size After Last Property [ Dumper-7 ])
		EWidgetLayer                                  WidgetLayer;                                       // 0x0414(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
		uint8                                         Pad_415[0xB];                                      // 0x0415(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])

	public:
		class UM1UIActorWidget* GetActorWidget() const;

	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1ActorWidgetComponent">();
		}
		static class UM1ActorWidgetComponent* GetDefaultObj()
		{
			return GetDefaultObjImpl<UM1ActorWidgetComponent>();
		}
	};
...
#pragma pack(pop)
	...
	// Class M1.M1FieldInteractableActor_UnsyncedInteraction
	// 0x0010 (0x0460 - 0x0450)
	class AM1FieldInteractableActor_UnsyncedInteraction final : public AM1FieldInteractableActor_Interaction
	{
	public:
		TArray<class AM1PlayerController*>            InteractedPlayers;                                 // 0x0450(0x0010)(Net, ZeroConstructor, Transient, RepNotify, NativeAccessSpecifierPrivate)
	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1FieldInteractableActor_UnsyncedInteraction">();
		}
		static class AM1FieldInteractableActor_UnsyncedInteraction* GetDefaultObj()
		{
			return GetDefaultObjImpl<AM1FieldInteractableActor_UnsyncedInteraction>();
		}
	};
	...
	// Class M1.M1DropContainerByMission
	...
	public:
		...
		bool                                          bShouldBeLaunched;                                 // 0x05E8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8                                         Pad_5E9[0x3];                                      // 0x05E9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
		struct FVector2D                              LaunchForceOverride;                               // 0x05EC(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8                                         Pad_5F4[0xC];                                      // 0x05F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
		bool                                          bIsSpawnedByCheat;                                 // 0x0600(0x0001)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8                                         Pad_601[0xF];                                      // 0x0601(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
		bool                                          bShouldDropAgainAfterWaitiningTime;                // 0x0610(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8                                         Pad_611[0xF];                                      // 0x0611(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])

	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1DropContainerByMission">();
		}
		static class AM1DropContainerByMission* GetDefaultObj()
		{
			return GetDefaultObjImpl<AM1DropContainerByMission>();
		}
	};
	...
	// Class M1.M1DropMissionCollectibles
	// 0x0010 (0x0630 - 0x0620)
	class AM1DropMissionCollectibles : public AM1DropContainerByMission
	{
	public:
		struct FM1DropMissionCollectiblesInfo         DropMissionCollectiblesInfo;                       // 0x0620(0x000C)(Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
	...
	public:
		...
		static class AM1DropMissionCollectibles* GetDefaultObj()
		{
			return GetDefaultObjImpl<AM1DropMissionCollectibles>();
		}
	};

	// Class M1.M1DropMissionSupplies// 0x0040 (0x0660 - 0x0620)
	class AM1DropMissionSupplies : public AM1DropContainerByMission
	{
	public:
		struct FM1DropMissionSuppliesInfo             DropMissionSuppliesInfo;                           // 0x0620(0x000C)(Net, RepNotify, NoDestructor, Protected, NativeAccessSpecifierProtected)
		uint8                                         Pad_62C[0x34];                                     // 0x062C(0x0034)(Fixing Struct Size After Last Property [ Dumper-7 ])
	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1DropMissionSupplies">();
		}
		static class AM1DropMissionSupplies* GetDefaultObj()
		{
			return GetDefaultObjImpl<AM1DropMissionSupplies>();
		}
	};

	// Class M1.M1DropContainerPickupWeapon
	// 0x0020 (0x0640 - 0x0620)
	class AM1DropContainerPickupWeapon : public AM1DropContainerByMission
	{
	public:
		class FName                                   PickupWeaponDataRowName;                           // 0x0620(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		bool                                          bRoundsTransferable;                               // 0x0628(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
		uint8                                         Pad_629[0x7];                                      // 0x0629(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
		class AM1Weapon* WeaponSpawned;                                     // 0x0630(0x0008)(Net, ZeroConstructor, Transient, RepNotify, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8                                         Pad_638[0x8];                                      // 0x0638(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1DropContainerPickupWeapon">();
		}
		static class AM1DropContainerPickupWeapon* GetDefaultObj()
		{
			return GetDefaultObjImpl<AM1DropContainerPickupWeapon>();
		}
	};

	// Class M1.M1DropContainerByMissionInstant
	// 0x0000 (0x0620 - 0x0620)
	class AM1DropContainerByMissionInstant final : public AM1DropContainerByMission
	{
	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1DropContainerByMissionInstant">();
		}
		static class AM1DropContainerByMissionInstant* GetDefaultObj()
		{
			return GetDefaultObjImpl<AM1DropContainerByMissionInstant>();
		}
	};

	// Class M1.M1DropContainerByMissionInstant_UnDisturbed
	// 0x0010 (0x0630 - 0x0620)
	class AM1DropContainerByMissionInstant_UnDisturbed final : public AM1DropContainerByMission
	{
	public:
		float                                         CustomInvokerRadius;                               // 0x0620(0x0004)(Net, ZeroConstructor, Transient, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		TWeakObjectPtr<class AM1TaskEventActor>       OptionalOwnerTaskActor;                            // 0x0624(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
		uint8                                         Pad_62C[0x4];                                      // 0x062C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
	public:
		static class UClass* StaticClass()
		{
			return StaticClassImpl<"M1DropContainerByMissionInstant_UnDisturbed">();
		}
		static class AM1DropContainerByMissionInstant_UnDisturbed* GetDefaultObj()
		{
			return GetDefaultObjImpl<AM1DropContainerByMissionInstant_UnDisturbed>();
		}
	};
	...
	{
	public:
		uint8 Pad_WireState[0x54];										   // 0x0248
		EM1WireState WireState;                                            // 0x029C
	...
	static_assert(offsetof(AM1WireCaster, WireState) == 0x029C, "Bad alignment");
	...
	{
	public:
		uint8                                         Pad_AM1StatBasedActor_Class[0x10];                  // 0x0338(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	};
	...
	{
	public:
		uint8										  Pad_CurrentState[0x29C];													// 0x0348					
		EM1MissionTargetState                         CurrentState; 															// 0x05E4(0x0001)
		uint8                                         Pad_AM1MissionTargetActor_Class[0x183];                                   // 0x05E5
	};
...
#pragma pack(pop)
	...
	//  48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 48 83 EC ?? 41 0F B6 E9 41
	...
	typedef void(__fastcall* tAccountEquipCustomizeCharacterSkin)(UM1AccountInventory* This, FM1TemplateId InCharacterTid, int UNKNOWN, FM1TemplateId InSkinTid, bool InEquipped);
	extern tAccountEquipCustomizeCharacterSkin native_AccountEquipCustomizeCharacterSkin;
	// 44 89 4C 24 20 53 55 56 57 41 56 48 83 EC 50 48 8D B1 88 00 00 00 89 54 24 30 45 33 F6 44 89 44
	static const char* EquipCustomizeCharacterSkin_Sig = "\x44\x89\x4C\x24\x20\x53\x55\x56\x57\x41\x56\x48\x83\xEC\x50\x48\x8D\xB1\x88\x00\x00\x00\x89\x54\x24\x30\x45\x33\xF6\x44\x89\x44";
	static const char* EquipCustomizeCharacterSkin_Mask = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx";
	...
	// 40 55 53 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 ?? ?? ?? ?? 48 81 EC 48 05 00 00 48 8B 05 ?? ?? ?? ?? 48 33 C4 48 89 85 ?? ?? ?? ?? 4D 8B E1 4D 8B F8
	static const char* LineTraceMultiSig = "\x0F\x8F\x00\x00\x00\x00\x4C\x89\x75\xC8";
	static const char* LineTraceMultiMask = "xx????xxxx";
	...
	struct M1SkillAbility_CanActivateAbility final
	{
	...
	struct M1PlayerVehicleHandlerComponent_ServerRequestDismountVehicle final
	{
	public:
		struct FGameplayTag                           InQueryTag;                                        // 0x0000(0x0008)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	};
